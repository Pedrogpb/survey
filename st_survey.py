...
#st.markdown("")
#st.markdown(f"Area de varredura (m): {scan_area}")

#if dist_line == 0:
    #st.markdown("")
   # st.markdown(f"Distância entre as linhas (m): Na extremidade de uma linha deve-se iniciar a linha seguinte")
#else:
 #   st.markdown("")
  #  st.markdown(f"Distância entre as linhas (m): {dist_line}")